...
function runPassword(strPassword, strFieldID)
{
	...
	check_passwd(strPassword,strFieldID);
}

// Checks whether the passwd feild is empty or not
function check_passwd(strPassword,strFieldID)
{
	if(strPassword == '')
	{
		// Get controls
