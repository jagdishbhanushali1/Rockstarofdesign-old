...
<div class="row-gray row-indent">
    <div id="plans-masthead">
        <h2 class="ui-heading">Powerful <em>Windows Hosting</em></h2>
        <img class="banner-img" id="thumb-win-hosting-host"src="../img/thumb-win-hosting.png">
        <ol>
    ...
    <div class="techi-bar">
    	<span>Supports:</span>
        <div class="img-wrp"><img class="tech-spec-2"src="../img/tech-spe-2.jpg"></div>
    </div>
</div>
...
<div id="plans-container">
    ...
    <ul class="country_specific_tabs">
            ...
            <li class="tab_US first" country="US">US Hosting</li>
            <li class="tab_IN" country="IN">IN Hosting</li>
            <li class="tab_UK last sel" country="UK">UK Hosting<div class="sel_tab" style="left: 97px;"></div></li>
    </ul>
</div>
<div class="plans-columns">
    
            <ul class="plan-list us_plan " style="display: none;">
    <form name="hostingplan" id="hostingplan_2586422" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="w2k">
        <input type="hidden" name="location" value="us">
        <input type="hidden" id="planid_id" name="planid" value="2586422">
        ...
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 100.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat"><strong>Single Domain</strong></li>
        <li class="p-feat">500 MB Disk Space</li>
        <li class="p-feat">10 GB Data Transfer</li>
        <li class="p-feat last">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="2586422_duration">
                
                    <option value="24">
                        2  Years at Rs. 100.00/month
                    </option>
                    <option value="12">
                        1  Year at Rs. 110.00/month
                    </option>
            </select>
        </li>
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('2586422','w2k');return false;">Buy Now</a></li>
    </form>
    <span class="p-cutout"></span>
</ul>
            <ul class="plan-list us_plan " style="display: none;">
    <form name="hostingplan" id="hostingplan_2586430" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="w2k">
        <input type="hidden" name="location" value="us">
        <input type="hidden" id="planid_id" name="planid" value="2586430">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        ...
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 130.99 <small class="p-duration">/MO</small></li>
        <li class="p-feat"><strong>Single Domain</strong></li>
        <li class="p-feat">1 GB Disk Space</li>
        <li class="p-feat">100 GB Data Transfer</li>
        <li class="p-feat last">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="2586430_duration">
                
                    <option value="24">
                        2  Years at Rs. 130.99/month
                    </option>
                    <option value="12">
                        1  Year at Rs. 140.99/month
                    </option>
            </select>
        </li>
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('2586430','w2k');return false;">Buy Now</a></li>
    </form>
    <span class="p-cutout"></span>
</ul>
            <ul class="plan-list us_plan plan-featured" style="display: none;">
    <form name="hostingplan" id="hostingplan_2586423" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="w2k">
        <input type="hidden" name="location" value="us">
        <input type="hidden" id="planid_id" name="planid" value="2586423">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        <input type="hidden" name="upgradeprice" value="">
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">Premium <b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 140.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat"><strong>Single Domain</strong></li>
        <li class="p-feat">5 GB Disk Space</li>
        <li class="p-feat">200 GB Data Transfer</li>
        <li class="p-feat last">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="2586423_duration">
                
                    <option value="24">
                        2  Years at Rs. 140.00/month
                    </option>
                    <option value="12">
                        1  Year at Rs. 150.00/month
                    </option>
            </select>
        </li>
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('2586423','w2k');return false;">Buy Now</a></li>
    </form>
    <span class="p-cutout"></span>
</ul>
            <ul class="plan-list us_plan " style="display: none;">
    <form name="hostingplan" id="hostingplan_2586421" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="w2k">
        <input type="hidden" name="location" value="us">
        <input type="hidden" id="planid_id" name="planid" value="2586421">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        <input type="hidden" name="upgradeprice" value="">
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">Platinum <b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 250.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat"><strong>Single Domain</strong></li>
        <li class="p-feat">Unlimited Disk Space</li>
        <li class="p-feat">Unlimited Data Transfer</li>
        <li class="p-feat last">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="2586421_duration">
                
                    <option value="12">
                        1  Year at Rs. 250.00/month
                    </option>
                    <option value="24">
                        2  Years at Rs. 250.00/month
                    </option>
            </select>
        </li>
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('2586421','w2k');return false;">Buy Now</a></li>
    </form>
    <span class="p-cutout"></span>
</ul>
            <ul class="plan-list in_plan plan-featured" style="display: none;">
    <form name="hostingplan" id="hostingplan_1596038" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="w2k">
        <input type="hidden" name="location" value="in">
        <input type="hidden" id="planid_id" name="planid" value="1596038">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        ...
        <li class="p-feat last">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="1596038_duration">
        ...
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('1596038','w2k');return false;">Buy Now</a></li>
    </form>
    <span class="p-cutout"></span>
</ul>
            <ul class="plan-list uk_plan plan-featured" style="display: inline-block;">
    <form name="hostingplan" id="hostingplan_1596011" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="w2k">
        <input type="hidden" name="location" value="uk">
        <input type="hidden" id="planid_id" name="planid" value="1596011">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        ...
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">Unlimited Hosting Plan <b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 216.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat"><strong>Single Domain</strong></li>
        <li class="p-feat">Unlimited Disk Space</li>
        <li class="p-feat">Unlimited Data Transfer</li>
        <li class="p-feat last">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="1596011_duration">
                
                    <option value="12">
                        1  Year at Rs. 216.00/month
                    </option>
            </select>
        </li>
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('1596011','w2k');return false;">Buy Now</a></li>
    </form>
    <span class="p-cutout"></span>
</ul>
</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.country_specific_tabs li').each(function(){
            ...
            if($('.' + country.toLowerCase() + '_plan').length == 0)
                $(this).remove();
        });
        ...
        $(".server_loc_tabs li:first").addClass('first');
        $(".server_loc_tabs li:last").addClass('last');
    });
...
<div class="row-white row-indent">
    ...
    <div class="addons-bar"><img class="add-on-bar-in-host" src="../img/addons.gif"></div>
	<!-- addon bar -->
...
<div class="features-wrp" id="fea-list">
    ...
    <div class="features lfloat">
        ...
        <!-- list -->
        <div class="list-cont ic-2">
            <h3>Powerful Control Panel - Plesk <span style="font-size: 12px;"><a href="" >(View Demo)</a></span></h3>
            <ul class="features">
                <li>World's Leading Hosting Control Panel</li>
                <li>Manage Web Pages, View Website Statistics, Create Email Accounts etc.</li>
                <li>Comes with Web Application Script Installer - Install Blogs, Shopping Carts etc.</li>
            </ul>
        </div>
        <!-- / -->
...
<div id="modal_div" class="modal-wrapper" style="display:none">
    <div class="modal_overlay" style="width: 1014px; height: 3101px;">
    </div>
