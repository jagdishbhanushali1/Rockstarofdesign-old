...
<div class="row-gray row-indent">
    <div id="plans-masthead">
        ...
        <img class="banner-img" src="img/thumb-rs-hosting.png">
        <ol>
 ...
 <div class="row-indent">
    <h2 class="ui-subheading">Select Your <em>Plan</em></h2>
</div>
<div id="plans-container">
    <br><br>
    <div class="plans-columns-wrp">
        <div class="server_loc_tabs" style="left: 211px;">
    <ul class="country_specific_tabs">
        
            <li class="tab_US sel" country="US">US Hosting<div class="sel_tab"></div></li>
...
<div class="plans-columns reseller-hosting">
            ...
            <ul class="plan-list us_plan " style="display: inline-block;">
    <form name="hostingplan" id="hostingplan_3" method="POST">
        ...
        <li class="p-name"><span class="pl-title">R1<b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 1,230.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat">40 GB Disk Space</li>
        <li class="p-feat">800 GB Data Transfer</li>
        <li class="p-feat">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="3_duration">
                
                    <option value="1">
                        1  Month at Rs. 1,230.00/month
                    </option>
            </select>
        </li>
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('3','resellerhosting');return false;">Buy Now</a></li>
    ...
    <form name="hostingplan" id="hostingplan_4" method="POST">
        ...
        <input type="hidden" name="upgradeprice" value="">
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">R2<b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 1,410.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat">50 GB Disk Space</li>
        <li class="p-feat">1000 GB Data Transfer</li>
        <li class="p-feat">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="4_duration">
                
                    <option value="1">
                        1  Month at Rs. 1,410.00/month
                    </option>
            </select>
        </li>
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('4','resellerhosting');return false;">Buy Now</a></li>
        <span class="p-cutout"></span>
    </form>
</ul>
            <ul class="plan-list us_plan plan-featured" style="display: inline-block;">
    <form name="hostingplan" id="hostingplan_5" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="resellerhosting">
        <input type="hidden" name="location" value="us">
        <input type="hidden" id="planid_id" name="planid" value="5">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        <input type="hidden" name="upgradeprice" value="">
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">R3<b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 1,860.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat">100 GB Disk Space</li>
        <li class="p-feat">2000 GB Data Transfer</li>
        <li class="p-feat">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="5_duration">
                
                    <option value="1">
                        1  Month at Rs. 1,860.00/month
                    </option>
            </select>
        </li>
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('5','resellerhosting');return false;">Buy Now</a></li>
        <span class="p-cutout"></span>
    </form>
</ul>
            <ul class="plan-list us_plan " style="display: inline-block;">
    <form name="hostingplan" id="hostingplan_6" method="POST">
        ...
        <input type="hidden" name="upgradeprice" value="">
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">R4<b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 2,820.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat">200 GB Disk Space</li>
        <li class="p-feat">4000 GB Data Transfer</li>
        <li class="p-feat">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="6_duration">
                
                    <option value="1">
                        1  Month at Rs. 2,820.00/month
                    </option>
            </select>
        </li>
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('6','resellerhosting');return false;">Buy Now</a></li>
        <span class="p-cutout"></span>
    </form>
</ul>
            <ul class="plan-list in_plan " style="display: none;">
    <form name="hostingplan" id="hostingplan_28" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="resellerhosting">
        <input type="hidden" name="location" value="in">
        <input type="hidden" id="planid_id" name="planid" value="28">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        <input type="hidden" name="upgradeprice" value="">
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">RLI-1<b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 1,230.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat">40 GB Disk Space</li>
        <li class="p-feat">800 GB Data Transfer</li>
        <li class="p-feat">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="28_duration">
        ...
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('28','resellerhosting');return false;">Buy Now</a></li>
        <span class="p-cutout"></span>
    </form>
</ul>
            <ul class="plan-list in_plan " style="display: none;">
    <form name="hostingplan" id="hostingplan_29" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="resellerhosting">
        <input type="hidden" name="location" value="in">
        <input type="hidden" id="planid_id" name="planid" value="29">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        <input type="hidden" name="upgradeprice" value="">
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">RLI-2<b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 1,410.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat">50 GB Disk Space</li>
        <li class="p-feat">1000 GB Data Transfer</li>
        <li class="p-feat">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="29_duration">
        ...
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('29','resellerhosting');return false;">Buy Now</a></li>
        <span class="p-cutout"></span>
    </form>
</ul>
            <ul class="plan-list in_plan plan-featured" style="display: none;">
    <form name="hostingplan" id="hostingplan_30" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="resellerhosting">
        <input type="hidden" name="location" value="in">
        <input type="hidden" id="planid_id" name="planid" value="30">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        <input type="hidden" name="upgradeprice" value="">
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">RLI-3<b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 1,860.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat">100 GB Disk Space</li>
        <li class="p-feat">2000 GB Data Transfer</li>
        <li class="p-feat">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="30_duration">
        ...
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('30','resellerhosting');return false;">Buy Now</a></li>
        <span class="p-cutout"></span>
    </form>
</ul>
            <ul class="plan-list in_plan " style="display: none;">
    <form name="hostingplan" id="hostingplan_31" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="resellerhosting">
        <input type="hidden" name="location" value="in">
        <input type="hidden" id="planid_id" name="planid" value="31">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        <input type="hidden" name="upgradeprice" value="">
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">RLI-4<b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 2,820.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat">200 GB Disk Space</li>
        <li class="p-feat">4000 GB Data Transfer</li>
        <li class="p-feat">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="31_duration">
        ...
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('31','resellerhosting');return false;">Buy Now</a></li>
        <span class="p-cutout"></span>
    </form>
</ul>
            <ul class="plan-list uk_plan " style="display: none;">
    <form name="hostingplan" id="hostingplan_40" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="resellerhosting">
        <input type="hidden" name="location" value="uk">
        <input type="hidden" id="planid_id" name="planid" value="40">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        <input type="hidden" name="upgradeprice" value="">
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">RH-1<b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 1,182.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat">40 GB Disk Space</li>
        <li class="p-feat">800 GB Data Transfer</li>
        <li class="p-feat">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="40_duration">
                
                    <option value="1">
                        1  Month at Rs. 1,182.00/month
                    </option>
            </select>
        </li>
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('40','resellerhosting');return false;">Buy Now</a></li>
        <span class="p-cutout"></span>
    </form>
</ul>
            <ul class="plan-list uk_plan " style="display: none;">
    <form name="hostingplan" id="hostingplan_41" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="resellerhosting">
        <input type="hidden" name="location" value="uk">
        <input type="hidden" id="planid_id" name="planid" value="41">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        <input type="hidden" name="upgradeprice" value="">
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">RH-2<b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 1,338.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat">50 GB Disk Space</li>
        <li class="p-feat">1000 GB Data Transfer</li>
        <li class="p-feat">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="41_duration">
                
                    <option value="1">
                        1  Month at Rs. 1,338.00/month
                    </option>
            </select>
        </li>
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('41','resellerhosting');return false;">Buy Now</a></li>
        <span class="p-cutout"></span>
    </form>
</ul>
            <ul class="plan-list uk_plan plan-featured" style="display: none;">
    <form name="hostingplan" id="hostingplan_42" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="resellerhosting">
        <input type="hidden" name="location" value="uk">
        <input type="hidden" id="planid_id" name="planid" value="42">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        <input type="hidden" name="upgradeprice" value="">
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">RH-3<b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 1,716.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat">100 GB Disk Space</li>
        <li class="p-feat">2000 GB Data Transfer</li>
        <li class="p-feat">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="42_duration">
                
                    <option value="1">
                        1  Month at Rs. 1,716.00/month
                    </option>
            </select>
        </li>
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('42','resellerhosting');return false;">Buy Now</a></li>
        <span class="p-cutout"></span>
    </form>
</ul>
            <ul class="plan-list uk_plan " style="display: none;">
    <form name="hostingplan" id="hostingplan_43" method="POST">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="type" id="type_id" value="resellerhosting">
        <input type="hidden" name="location" value="uk">
        <input type="hidden" id="planid_id" name="planid" value="43">
        <input type="hidden" name="domain_name" value="">
        <input type="hidden" name="otherdomain" value="">
        <input type="hidden" name="orderid" value="">
        <input type="hidden" name="upgrade" value="">
        <input type="hidden" name="upgradeprice" value="">
        <input type="hidden" name="old_plan_name" value="">
        <li class="p-name"><span class="pl-title">RH-4<b></b></span></li>
        <li class="p-pricing"><small class="p-currency"><span class="WebRupee">Rs.</span></small> 2,514.00 <small class="p-duration">/MO</small></li>
        <li class="p-feat">200 GB Disk Space</li>
        <li class="p-feat">4000 GB Data Transfer</li>
        <li class="p-feat">Unlimited Email Accounts</li>
        <li class="p-dropdown">
            <select name="duration" id="43_duration">
                
                    <option value="1">
                        1  Month at Rs. 2,514.00/month
                    </option>
            </select>
        </li>
        <li class="p-button"><a class="txt-button" onclick="populate_hostingplan_with_domain_form('43','resellerhosting');return false;">Buy Now</a></li>
        <span class="p-cutout"></span>
    </form>
</ul>
</div>
...
<div class="row-white row-indent"> 
    ...
    <!-- addon bar -->
    <h2 class="ui-subheading">Install these softwares in just 1 - click!</h2>
    <div class="addons-bar"><img src="img/addons.gif"></div>
    <!-- addon bar -->
...
<div class="features-wrp" id="fea-list">
    ...
    <div class="features lfloat">
        ...
        <!-- list -->
        <div class="list-cont ic-1 first">
        ...
        <div class="list-cont ic-2-cpanel">
            <h3>Powerful Control Panel - cPanel <span style="font-size: 12px;"><a href="" target="_blank">(View Demo)</a></span></h3>
    ...
    <div class="faq lfloat">
        ...
        <ul class="bullet-list">
            <li>PHP 5.2x, Perl, Python, GD, cURL, CGI, mcrypt</li>
            <li>Apache 2.2x</li>
            <li>MySQL 5</li>
...
<div id="modal_div" class="modal-wrapper" style="display:none">
    <div class="modal_overlay" style="background-color: rgb(0, 0, 0); width: 1014px; height: 3081px; background-position: initial initial; background-repeat: initial initial;">
    </div>
		...
		<div>
			<form name="hostingplan_with_domain" id="hostingplan_with_domain" action="../domain-registration/index.php" method="POST" onsubmit="return check_domainname_submit();">
				...
				<script type="text/javascript">
					...
					function show_otherbox_for_domain_name()
					{
						if($('#domainname_opt_id').val() == 'other')
							$('#other_domain_name').show();
						else
							$('#other_domain_name').hide();
					}
					function check_domainname_submit()
					{
						var domainname = $("#new-domain-name").val();
						domainname = jQuery.trim(domainname);
						if(domainname == '')
						{
