...
<div class="footer-cols">
	<div class="col one">
		...
		<ul class="secondary-links">
			...
			<li><a href="../domain-registration/bulk-domain-transfer.php">Bulk Domain Transfer</a></li>
	...
	<div class="col two">
		...
		<ul class="secondary-links">
            ...
            <li><a href="../website-design/index.php">Website Builder</a></li>
            <li><a href="../web-hosting/email-hosting.php">Email</a></li>
            <li><a href="../digital-ssl-certificate/index.php">SSL</a></li>
        </ul>
	</div>
...
<p id="fineprint">Copyright &copy; Bigrock. All rights reserved</p>
...
<script type="text/javascript" src="../js/loading_animation.js"></script>
